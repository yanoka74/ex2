...
**Domain:** Python Excel processing web app (sales data analysis)
...
# Core dependencies
pip install flask==3.1.3 pandas==2.2.3 openpyxl==3.1.5
...
---
*Stack research for: 판매정보 엑셀 분석 웹앱*
*Researched: 2026-04-10*
